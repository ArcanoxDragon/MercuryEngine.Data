...
public class PropertyExpressionFieldAdapter<TOwner, TProperty>(Expression<Func<TOwner, TProperty>> propertyExpression) : IFieldAdapter<TOwner, TProperty>
{
	private readonly PropertyInfo propertyInfo = ReflectionUtility.GetProperty(propertyExpression);
